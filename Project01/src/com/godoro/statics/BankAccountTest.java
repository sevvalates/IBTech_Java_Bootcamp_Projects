...
public class BankAccountTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("Tutar I Yıllık: "+account1.getAmount(BankAccount.MONTHS_IN_YEAR));
		//System.out.println("Tutar 3 Aylık: "+account1.getAmount(BankPeriod.PERIOD_3Q));


		BankAccount account2=new BankAccount();
		account2.setInvestment(4000);
		System.out.println("Tutar II 9 Aylık: "+account2.getAmount(9));
		System.out.println("Tutar II Yıllık: "+account2.getAmount(BankAccount.MONTHS_IN_YEAR));
